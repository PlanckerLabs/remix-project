...
export const runTabReducer = (state: RunTabState = runTabInitialState, action: Action) => {
  ...
  case SET_DAPPDRAFT_ACTIVATED: {
    const payload: boolean = action.payload
    return {
      ...state,
      dappdraftActivated: payload
    }
  }
